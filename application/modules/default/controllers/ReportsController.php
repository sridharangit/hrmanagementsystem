...
class Default_ReportsController extends Zend_Controller_Action
{
	...
	public function preDispatch()
	{
		...
		$ajaxContext->addActionContext('getemploginreportdata', 'html')->initContext();
	...
	**/
	...
	public function getemploginreportdataAction()
	{
	...
	public function employeeloginreportAction()
	{
            $norec_arr = array();
            $form = new Default_Form_Employeereport();
            $requi_model = new Default_Model_Requisition();
