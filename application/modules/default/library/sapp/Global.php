  ...
  ?>";
        ...
        public static function generateAccessControl_helper5($group_id,$role_id,$role_type)
        {
            ...
            if($group_id == EMPLOYEE_GROUP || $group_id == HR_GROUP || $group_id == MANAGEMENT_GROUP  || $role_id == SUPERADMINROLE)//for Employee,management ,HR groups
            {
					...
					$employeelogin_controllers = array('employeelogincontroller.php'=>array('url'=>'employeelogin','modulename'=>'default','actions'=>array()));
                    $rcontent .= self::generateAccessControl_helper3($employeelogin_controllers, $role_id, $roles['roletype']);
