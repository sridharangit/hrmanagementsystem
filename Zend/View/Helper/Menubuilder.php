		...
		*** commented to remove menu icon 07-08-2015 - END - ***/
		...
		if($emprole==5){
			...
			if(!empty($last_Check_out) || empty($last_EmployeeData)){
				...
				{
					$parent_menu .= "<li class='time_entry checkinout_entry reports-div active' data-val='1' data-updateid='0' id='weekli' style='background-color:yellow;'><span class='menu_icon'></span><p class='one-line' style='color:black'>Check In</p></li>";
				}
			}
			// else
			// {
			// 	$parent_menu .= "<select class='checkour_reason' id='checkour_reason'>
			...
			// 	</select>";
			// 	$parent_menu .= "<li class='lastcheckout_entry hide reports-div active' data-val='".$last_Check_id."' id='weekli' style='background-color:yellow;'><span class='menu_icon'></span><p class='one-line' style='color:black'>Check In </p></li>";
			// }
		}
