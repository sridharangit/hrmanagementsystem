      ...
      /*  $reportsArr = array('leavesreport'=>'Leaves','holidaygroupreports'=>'Holidays','activeuser'=>'Active Users',
        ...
        else if($pageName == 'reports')
        {
            ...
            if(isset($actionName) && $actionName !='')
            {
				...
				else if($actionName == 'employeeloginreport')
					$breadCrumbsData .= '<span class="arrows">&rsaquo;</span>Employees Login<span class="arrows">&rsaquo;</span><span>Employees Login Report</span>';
