	...
	public  function reportsheader($module)
	{
	     $reportsheader = '';
		    ...
		    $reportsheader .='</li>';
				...
				$reportsheader .='<li class="reports-div" id="employeelogin_rpt_div" >';
			if($module == 'employeeloginreport')
			{
		    $reportsheader .='<span class="reports-sprite emp-login-report-selected"></span>';
			$reportsheader .='<p class="one-line selected-report">Employees Login</p>';
			}else
            {
			$reportsheader .='<span class="reports-sprite emp-login-report"></span>';
			$reportsheader .='<p class="one-line">Employees Login</p>';
			}
		    $reportsheader .='</li>';
